...
if ($result->rowCount()==0) print"<br/><br/><p align=\"center\"><font color=\"#CC0000\"><strong>". NOEXISTE."</strong></font></p>";
else {
	$row=$result->fetch(PDO::FETCH_NUM);
	$pass=subStr(md5($row[1].$row[0].date("j-m-Y H:i:s")),1,8);
	$sql="UPDATE chimiste SET chi_password='".md5($pass)."' WHERE chi_id_chimiste='$row[0]'";
	$updat=$dbh->exec($sql);
	if($updat==1) {
