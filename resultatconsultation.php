...
elseif (!empty ($_POST['formbrute']) or $_POST['massemol']!="" or !empty($_POST['mol']) or !empty($_POST['numero']) or !empty($_POST['refcahier'])) {
	...
	if ($_POST['numero']!="") {
		if ($row[0]=="{ADMINISTRATEUR}") {
			$sql="SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE (pro_num_constant='".intval($_POST['numero'])."' or pro_numero='".$_POST['numero']."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste order by pro_id_structure";
			$result2 = $dbh->query($sql);
			$nbrs=$result2->rowCount();
			$nbpage=ceil($nbrs/$limitepage); // retourne le nombre de pages pris par la requête
			$sql=$sql." LIMIT $limitepage OFFSET $nbrequete";
			$result3 = $dbh->query($sql);
			while($row3=$result3->fetch(PDO::FETCH_NUM)) {
				$sql="SELECT DISTINCT pro_id_produit,pro_id_structure FROM produit,chimiste,structure WHERE (pro_numero='".$_POST['numero']."' or pro_num_constant='".intval($_POST['numero'])."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and pro_id_structure='$row3[0]' and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste order by pro_id_structure";
				$result4 = $dbh->query($sql);
				while ($row4=$result4->fetch(PDO::FETCH_NUM)) {
					$tab[$row4[0]]=$row4[1];
				}
		 ...
		 elseif ($row[0]=="{CHEF}") {
			...
			$sql="(SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE ($requete) and (pro_numero='".$_POST['numero']."' or pro_num_constant='".intval($_POST['numero'])."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste) UNION (SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE pro_id_chimiste='".$row[1]."' and (pro_numero='".$_POST['numero']."' or pro_num_constant='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste) order by pro_id_structure";
			$result2 = $dbh->query($sql);
			$nbrs=$result2->rowCount();
			$nbpage=ceil($nbrs/$limitepage); // retourne le nombre de pages pris par la requête
			$sql=$sql." LIMIT $limitepage OFFSET $nbrequete";
		...
		elseif($row[0]=="{RESPONSABLE}") {
			$sql="(SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE pro_id_equipe='".$row[2]."' and (pro_numero='".$_POST['numero']."' or pro_num_constant='".intval($_POST['numero'])."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste) UNION (SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE chi_nom='".$_SESSION['nom']."' and (pro_numero='".$_POST['numero']."' or pro_num_constant='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste) order by pro_id_structure";
			$result2 = $dbh->query($sql);
			$nbrs=$result2->rowCount();
			$nbpage=ceil($nbrs/$limitepage); // retourne le nombre de pages pris par la requête
			$sql=$sql." LIMIT $limitepage OFFSET $nbrequete";
			...
			$sql="SELECT DISTINCT pro_id_structure FROM produit,chimiste,structure WHERE chi_nom='".$_SESSION['nom']."' and (pro_numero='".$_POST['numero']."' or pro_num_constant='".intval($_POST['numero'])."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste order by pro_id_structure";
			$result2 = $dbh->query($sql);
			$nbrs=$result2->rowCount();
			$nbpage=ceil($nbrs/$limitepage); // retourne le nombre de pages pris par la requête
			$sql=$sql." LIMIT $limitepage OFFSET $nbrequete";
			$result3 = $dbh->query($sql);
			while($row3=$result3->fetch(PDO::FETCH_NUM)) {
					$sql="SELECT DISTINCT pro_id_produit,pro_id_structure FROM produit,chimiste,structure WHERE chi_nom='".$_SESSION['nom']."' and (pro_numero='".$_POST['numero']."' or pro_num_constant='".intval($_POST['numero'])."' or pro_num_cn='".$_POST['numero']."' or pro_qrcode='".$_POST['numero']."') and pro_id_structure='$row3[0]' and structure.str_id_structure=produit.pro_id_structure and chimiste.chi_id_chimiste=produit.pro_id_chimiste order by pro_id_structure";
					$result4 = $dbh->query($sql);
					while ($row4=$result4->fetch(PDO::FETCH_NUM)) {
						$tab[$row4[0]]=$row4[1];
					}
