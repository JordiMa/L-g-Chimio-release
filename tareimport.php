...
if (($_FILES['filetare']['type']=="application/vnd.ms-excel" or $_FILES['filetare']['type']=="text/csv" or $_FILES['filetare']['type']=="text/x-comma-separated-values" or $_FILES['filetare']['type']=="application/force-download" or $_FILES['filetare']['type']=="text/comma-separated-values") and $_FILES['filetare']['size']<=$maxup) $transfert=true;
$menu=9;
$ssmenu=11;
