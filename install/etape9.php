...
if (empty($erreur)) {
	...
	$sql="INSERT INTO chimiste (chi_nom ,chi_prenom,chi_password,chi_email ,chi_recevoir, chi_langue ,chi_statut) VALUES ('".$_POST['chinom']."','".$_POST['chiprenom']."','".$pass."','".$_POST['chiemail']."','1','".$_POST['langue']."','{ADMINISTRATEUR}')";
