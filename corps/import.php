...
if ($row[0]=='{ADMINISTRATEUR}') {
	...
	echo "<br/><h3 align=\"center\">".TITREIMPORT."</h3>";
	if (!empty($erreur)) echo "<p align=\"center\" class=\"erreur\">".constant($erreur)."</p>";
	//formulaire d'importation du fichier
	$formulaire=new formulaire ("csv","csvimport.php","POST",true);
	$formulaire->affiche_formulaire();
	echo "<br/>";
	$formulaire->ajout_file (30, "fileCN",true,FICHIERIMPORTCSV."<br/>","");
	$formulaire->ajout_button (SUBMIT,"","submit","");
	print"<a href=\"#\" onmouseover=\"ddrivetip('<p align=\'justify\'>".AddSlashes(AIDECN)."</p>')\" onmouseout=\"hideddrivetip()\"><img border=\"0\" src=\"images/aide.gif\" /></a>";
	$formulaire->fin();
}
