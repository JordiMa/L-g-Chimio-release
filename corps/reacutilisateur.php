...
if ($row[0]=='{ADMINISTRATEUR}') {
	...
	print"<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
		  <tr>
			...
			<td width=\"82\" height=\"23\" align=\"center\" valign=\"middle\" background=\"images/onglet1.gif\"><a class=\"onglet\" href=\"utilisateurreac.php\">".REAC."</a></td>
    ...
    $sql="SELECT chi_nom,chi_prenom,chi_email,chi_recevoir,chi_langue,chi_statut,chi_id_responsable,chi_id_equipe,chi_passif,chi_id_chimiste FROM chimiste WHERE chi_passif='TRUE' ORDER BY chi_nom,chi_prenom";
    ...
    while ($row=$resultat->fetch(PDO::FETCH_NUM)) {
		...
		print"><td>$row[0]</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>".constant($row[5])."</td><td>$row[6]</td><td>$row2[0]</td><td>$row[8]</td><td><a href=\"utilisateurreac.php?idutil=$row[9]\">".REAC."</a></td></tr>";
		$col++;
	}
    print"</table>";
}
