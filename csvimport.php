...
//le mime type application/force-download répond à un problème avec Mozilla qui ne reconnait pas le CSV
if (($_FILES['fileCN']['type']=="application/vnd.ms-excel" or $_FILES['fileCN']['type']=="text/csv" or $_FILES['fileCN']['type']=="text/comma-separated-values" or $_FILES['fileCN']['type']=="text/x-comma-separated-values" or $_FILES['fileCN']['type']=="application/force-download") and $_FILES['fileCN']['size']<=$maxup) $transfert=true;
$menu=9;
$ssmenu=10;
